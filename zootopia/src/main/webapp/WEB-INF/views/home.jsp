                        ...
                        <c:choose>
                            <c:when test="${not empty userinfo.member_id}">
                                <a href="${pageContext.request.contextPath}/member/logout"
                                    ...
                                    data-wow-delay="0.8s">로그아웃</a>
                                <a href="${pageContext.request.contextPath}/member/mypage"
                                    class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs"
                                    data-wow-delay="0.8s">마이페이지</a>
                            </c:when>
                            <c:otherwise>
                                <a href="${pageContext.request.contextPath}/member/login"
                                    class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs"
                                    data-wow-delay="0.8s">로그인</a>
                                <a href="${pageContext.request.contextPath}/member/join"
                                    class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs"
                                    data-wow-delay="0.8s">회원가입</a>
                            </c:otherwise>
                        </c:choose>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <img src="${pageContext.request.contextPath}/res/img/about-img.png"
                        class="img-responsive wow fadeInUp" alt="About">
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="media wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="media-body">
                            ...
                            <p>
                                어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구
                                저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구어쩌구 저쩌구
                            </p>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="card border-success mb-4"
                                                ...
                                                <div class="card-body">
                                                    <div class="box" style="background: #BDBDBD;">
                                                        <img class="profile" src="/img/nojingu.jpg">
                                                    </div>
                                                    <br>
                                                    <h4 class="card-title">${petsitterDto.petsitter_nick}</h4>
                                                    <p class="card-text">후기 : 정말 친절하세요정말 친절하세요정말 친절하세요정말 친절하세요정말 친절하세요정말친절하세요</p>
                                                    <button type="button" class="btn btn-primary">후기 더보기</button>
                                                </div>
                                            </div>
                                        </td> 
                                    </c:forEach>
