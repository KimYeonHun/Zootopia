        ...
        <div class="w3-container w3-card-4">
            ...
            <div>
                <form action="mypage2" method="post">
                    ...
                    <p>
                        <label>이메일</label>
                        <input class="w3-input" type="text" name="email" value="${memberDto.email}">
                    </p>
                    <p>
                        <label>전화 번호</label>
                        <input class="w3-input" type="text" name="phone" value="${memberDto.phone}">
                    </p>
                    ...
                    <p>
                        <label>우편번호</label>
                        <input type="text" id="sample6_postcode"  name="post" class="w3-form" value="${memberDto.post}"><br>

                    </p>
                    <p>
                        <label>주소</label>
                    	<input type="text" id="sample6_address"  name="baseaddr" class="w3-form" value="${memberDto.baseaddr}"><br>

                    </p>
                    <p>
                        <label>상세 주소</label>
						<input type="text" id="sample6_detailAddress"   name="extraaddr" class="w3-form" value="${memberDto.extraaddr}">
