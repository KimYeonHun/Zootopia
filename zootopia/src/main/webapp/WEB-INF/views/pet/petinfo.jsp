		...
		<div class="row">
			<div class="offset-sm-4 col-sm-4 jumbotron">
				...
				<form action="petinfo" method="post">
					...
					<div class="form-group">
						<div class="btn-group btn-group-toggle" data-toggle="buttons">
							<label class="btn btn-info">대표 펫 크기</label> <select
								name="pet_size">
					...
					<div class="form-group">
						<label>펫 마리 수</label> <input type="number" name="pet_total"
							class="form-control">
					</div>

					<label>세부 사항</label>
					<div class="form-group">
						<textarea name="pet_intro" cols="55" rows="10" autofocus required
							wrap="hard" placeholder="세부 사항을 적어주세요"></textarea>
					...
					<button id="submit" type="submit"
						class="btn-group btn-group-toggle">등록</button>
				</form>
			</div>
		</div>
	</div>
